### v7.0.0
* Изменена логика авторизации через СУДИР:
  * Изменена схема конфигурации для авторизации через СУДИР
  * Изменён контракт взаимодействия по `admin/auth/login_with_sudir`
### v6.8.2
* обновлены зависимости
### v6.8.1
* Обновлен isp-kit
### v6.8.0
* Изменен контракт методов. В запросах теперь массив идентификаторов пользователей и массив статусов сессий
* Обновлена версия go
### v6.7.0
